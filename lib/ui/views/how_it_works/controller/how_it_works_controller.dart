...
class HowItWorksController extends GetxController {
  ...
  List<HowItWorkModel> nfl = [
    HowItWorkModel(title: 'oFFENSIVEPLAYER'.tr, imagePath: '', innerTitle: [
      InnerTitle(score: '+100', subtitle: 'passingyardsper25Yards'.tr),
      InnerTitle(score: '+400', subtitle: 'passingTouchdowns'.tr),
      InnerTitle(score: '-200', subtitle: 'passingInterpolations'.tr),
      InnerTitle(score: '+100', subtitle: 'rushing10perYards'.tr),
      InnerTitle(score: '+600', subtitle: 'rushingTouchdowns'.tr),
      InnerTitle(score: '+100', subtitle: 'receptionsonlyifusingPPRScoring'.tr),
      InnerTitle(score: '+100', subtitle: 'receivingYardsper10yards'.tr),
      InnerTitle(score: '+600', subtitle: 'receivingTouchdowns'.tr),
      InnerTitle(score: '+200', subtitle: '2PointConversions'.tr),
      InnerTitle(score: '-200', subtitle: 'fumblesLost'.tr),
      InnerTitle(score: '+600', subtitle: 'fumblesRecoveredforaTouchdown'.tr),
    ]),
    HowItWorkModel(title: 'tEAMDEFENSE'.tr, imagePath: '', innerTitle: [
      InnerTitle(score: '+100', subtitle: 'sacks'.tr),
      InnerTitle(score: '+200', subtitle: 'interceptions'.tr),
      InnerTitle(score: '+200', subtitle: 'fumblesRecoveed'.tr),
      InnerTitle(score: '+200', subtitle: 'safeties'.tr),
      InnerTitle(score: '+600', subtitle: 'defensiveTouchdowns'.tr),
      InnerTitle(score: '+600', subtitle: 'kickandPuntReturnTouchdowns'.tr),
      InnerTitle(score: '+200', subtitle: '2PointConversionsReturns'.tr),
      InnerTitle(score: '+1000', subtitle: 'pointsAllowed(0)'.tr),
      InnerTitle(score: '+700', subtitle: 'pointsAllowed(1-6)'.tr),
      InnerTitle(score: '+400', subtitle: 'poinstAllowed(7-13)'.tr),
      InnerTitle(score: '+100', subtitle: 'pointasAllowed(14-20)'.tr),
      InnerTitle(score: '0', subtitle: 'pointsAllowed(21-27)'.tr),
      InnerTitle(score: '-100', subtitle: 'pointsAllowed(28-34)'.tr),
      InnerTitle(score: '-400', subtitle: 'pointsAllowed(35+)'.tr),
    ]),
    HowItWorkModel(
        title: 'iNDIVIDUALDEFENSEPLAYER'.tr,
        imagePath: '',
        innerTitle: [
          InnerTitle(score: '+100', subtitle: 'soloTackles'.tr),
          InnerTitle(score: '+50', subtitle: 'assistTackles'.tr),
          InnerTitle(score: '+200', subtitle: 'sacks'.tr),
          InnerTitle(score: '+100', subtitle: 'sacksper10yards'.tr),
          InnerTitle(score: '+100', subtitle: 'tackelsForLoss'.tr),
          InnerTitle(score: '+100', subtitle: 'quarterbacksHits'.tr),
          InnerTitle(score: '+100', subtitle: 'phasesDefended'.tr),
          InnerTitle(score: '+300', subtitle: 'interceptions'.tr),
          InnerTitle(score: '+300', subtitle: 'fumblesForced'.tr),
          InnerTitle(score: '+300', subtitle: 'fumblesRecovered'.tr),
          InnerTitle(score: '+600', subtitle: 'defensiveTouchdowns'.tr),
          InnerTitle(score: '+200', subtitle: '2PointConversionsReturns'.tr),
        ]),
    HowItWorkModel(title: 'kICKING'.tr, imagePath: '', innerTitle: [
      ...
      InnerTitle(score: '+100', subtitle: 'pATMade'.tr),
      InnerTitle(score: '+300', subtitle: 'fGMade049yardas'.tr),
      InnerTitle(score: '+500', subtitle: 'fGMade50yardas'.tr),
    ]),
  ];
