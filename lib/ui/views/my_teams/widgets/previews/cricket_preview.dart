...
class CricketPreview extends StatelessWidget {
  final List<MyTeamPlayersModel> data;
  const CricketPreview({super.key, required this.data});

  @override
  Widget build(BuildContext context) {
    final screenWidth = MediaQuery.of(context).size.width;
    final outerCircleRadius = screenWidth * 1;
    final innerCircleRadius = screenWidth * 0.5;
