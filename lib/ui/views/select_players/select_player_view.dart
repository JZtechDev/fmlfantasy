                    ...
                    builder: (context, snapshot) {
                      if (snapshot.connectionState == ConnectionState.waiting) {
                        ...
                        return Obx(() {
                          ...
                          // controller.combi nedPlayers.clear();

                          // if (controller.isSelectedTeamFliter.value == 'home') {
                          //   if (selectTeam.homeTeam?.players != null) {
                          //     controller.combinedPlayers.addAll(selectTeam
                          //         .homeTeam!.players!
                          //         .map((player) => [
                          //               player,
                          //               selectTeam.homeTeam!.name ?? 'Home Team'
                          //             ])
                          //         .toList());
                          //   }
                          // } else if (controller.isSelectedTeamFliter.value ==
                          //     'away') {
                          ...
                          //         .map((player) => [
                          //               player,
                          //               selectTeam.awayTeam!.name ?? 'Away Team'
                          //             ])
                          //         .toList());
                          //   }
                          // } else {
                          ...
                          //   }
                          // }
                          // if (controller.isPostion.isNotEmpty) {
                          //   controller.combinedPlayers = controller
                          //       .combinedPlayers
                          //       .where((player) =>
                          //           getInitials(player[0].position) ==
